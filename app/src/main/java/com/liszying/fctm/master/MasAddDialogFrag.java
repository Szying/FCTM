package com.liszying.fctm.master;
...
import com.liszying.fctm.MainActivity;
...
/**
 * Created by com.liszying.fctm on 2015/3/7.
 */
public class MasAddDialogFrag extends DialogFragment implements IHttpCompleted {
    ...
    String memberId= MainActivity.m.get_id();
    String[] allworks;
    ...
    public void onAttach(Activity activity) {
        ...
        allworks = getResources().getStringArray(com.liszying.fctm.R.array.onschdule);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(getResources().getString(com.liszying.fctm.R.string.labmagtitle));
        LayoutInflater inflater = getActivity().getLayoutInflater();
        view = inflater.inflate(com.liszying.fctm.R.layout.masschadd, null);

        initView(view);


        builder.setView(view);
        builder.setNegativeButton(com.liszying.fctm.R.string.Cancel, null);
    ...
    public void setMasValue() {
        if(editdata !="") {
            ...
            if(spiltData.length==5) {
                ...
                //放回spinner值
                String[] arraysch=getResources().getStringArray(com.liszying.fctm.R.array.onschdule);
    ...
    public void initView(final View view) {
        show2 = (EditText) view.findViewById(com.liszying.fctm.R.id.mas_heathendtime);
        show3 = (EditText) view.findViewById(com.liszying.fctm.R.id.masendtime2);
        masDB = new MasDbHelper(getActivity());



        //預設日期值
        everyday = (EditText) view.findViewById(com.liszying.fctm.R.id.everyday);
        everyday.setText(com.liszying.fctm.R.string.onschdule);

        // 建立ArrayList
        mylist = new ArrayList<HashMap<String, String>>();
        //spinner 工作選項
        spanworkitem = (Spinner) view.findViewById(com.liszying.fctm.R.id.spanworkitem2);

        //spinner Relation
        tmespin = (EditText) view.findViewById(com.liszying.fctm.R.id.tmespin2);
        spanworkitem.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(view.getContext(), getResources().getString(com.liszying.fctm.R.string.selecterror), Toast.LENGTH_LONG).show();
            }
        });

        //日期值
        ((EditText) view.findViewById(com.liszying.fctm.R.id.everyday)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //時間起
        ((EditText) view.findViewById(com.liszying.fctm.R.id.mas_heathendtime)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        //時間值止
        ((EditText) view.findViewById(com.liszying.fctm.R.id.masendtime2)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//        });
        //新增
        ImageButton imgbtn = (ImageButton) view.findViewById(com.liszying.fctm.R.id.btnaddmas);
        imgbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (everyday.getText().toString() == "" | show2.getText().toString() == "" || show3.getText().toString() == "" || tmespin.getText().toString() == "") {
                    Toast.makeText(view.getContext(), getResources().getString(com.liszying.fctm.R.string.fillfields), Toast.LENGTH_SHORT).show();
                } else {
                    masDB.add(everyday.getText().toString(), show2.getText().toString(), show3.getText().toString(), tmespin.getText().toString(), "NEW", memberId);
                    Toast.makeText(view.getContext(),getResources().getString(com.liszying.fctm.R.string.addsuccess), Toast.LENGTH_SHORT).show();
