...
public class DialogLogin extends DialogFragment implements IHttpCompleted {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(com.liszying.fctm.R.layout.dialog_login, null);

         txtUsername = (TextView) view.findViewById(com.liszying.fctm.R.id.editUsername);
        txtPassword = (TextView) view.findViewById(com.liszying.fctm.R.id.editPassword);

        Spinner mchooseUsertype = (Spinner) view.findViewById(com.liszying.fctm.R.id.chooseUsertype);
        ArrayAdapter<CharSequence> adapList =
                ArrayAdapter.createFromResource(getActivity(),
                        com.liszying.fctm.R.array.UserType_list,
...
//        chooseUsertype.setAdapter(adapter);
        builder.setPositiveButton(com.liszying.fctm.R.string.longIn, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNeutralButton(com.liszying.fctm.R.string.new_id, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
        ...
        builder.setNegativeButton(com.liszying.fctm.R.string.close, null);
        // 設定對話盒介面
    ...
    Spinner.OnItemSelectedListener spnListener = new Spinner.OnItemSelectedListener() {
        public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
            ...
            if (muserType.equals(getString(com.liszying.fctm.R.string.Master))) {
