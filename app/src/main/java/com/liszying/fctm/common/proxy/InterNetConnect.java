...
public class InterNetConnect extends Fragment implements IHttpCompleted {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.liszying.fctm.R.layout.interconnect, container, false);
    }
    ...
    public void showView() {
        ...
        TextView txtView = (TextView) getActivity().findViewById(com.liszying.fctm.R.id.txtView);
    ...
    private class MyAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                //        "&extraString=" + extraString);
                URL url = new URL("http://100.64.89.212:8080/FCTM/schedul?action=" + action +
                        "&extraString=" + extraString +
                        "&extraString=" + extraString);
