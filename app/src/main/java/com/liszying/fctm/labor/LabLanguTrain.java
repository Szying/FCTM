...
public class LabLanguTrain extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(com.liszying.fctm.R.layout.labtranhtml5, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        WebView mWebView = (WebView) getActivity().findViewById(com.liszying.fctm.R.id.trainwebvw1);
